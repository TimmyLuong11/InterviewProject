<Serializable()> Public Class CVender
    ...
    'Added state, zip, phone paramarters
    Public Sub New(ByVal psName As String, Optional ByVal psAddr As String = "", Optional ByVal psCity As String = "", Optional ByVal psState As Integer = 0, Optional ByVal psZip As Integer = 0, Optional ByVal psPhone As Integer = 0)
        csName = psName
        csAddress = psAddr
        csCity = psCity

        'Added the paramerters to variable
        esState = psState
        ciZipcode = psZip
        ciPhoneNumber = psPhone
